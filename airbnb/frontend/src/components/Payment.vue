...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="MemId" v-model="value.memId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            MemId :  {{value.memId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="MileageUsed" v-model="value.mileageUsed"/>
          </div>
          <div class="grey--text ml-4" v-else>
            MileageUsed :  {{value.mileageUsed }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="PrdId" v-model="value.prdId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            PrdId :  {{value.prdId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="OrdId" v-model="value.ordId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            OrdId :  {{value.ordId }}
          </div>
